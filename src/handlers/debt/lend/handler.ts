...
import { LendDebtResult, LendDebtResponse } from './response'

export const lendDebtHandler: RouteHandlerMethod = async function (request, reply): RouteHanderResult<LendDebtResponse> {
    const body = request.body as LendDebtRequest
    ...
    // result
    const result: LendDebtResult = null

    // response
    const response: LendDebtResponse = {
        result: result,
