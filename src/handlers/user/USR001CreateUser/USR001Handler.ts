...
import { USR001RequestType } from './USR001Request'
import { USR001ResponseType, USR001ResultType } from './USR001Response'

export const USR001Handler: RouteHandlerMethod = async function (request, reply): RouteHanderResult<USR001ResponseType> {
    const body = request.body as USR001RequestType
    ...
    // response
    const response: USR001ResponseType = {
        result: result,
